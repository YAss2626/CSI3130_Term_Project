...
typedef struct PlanState
{
	...
	TupleTableSlot* ps_InnerTupleSlot;   /* CSI3130: slot for "inner" tuple */
...
typedef struct HashJoinState
{
	...
	List	   *hashclauses;	/* list of ExprState nodes */
	 /* CSI3130: two hash tables for symmetric hash join */
    HashJoinTable inner_hj_HashTable;   /* inner hash table */
    HashJoinTable outer_hj_HashTable;   /* outer hash table */

	/* CSI3130: current hash values, buckets, and tuples for both sides */
 ...
 /* Existing lists of hash expressions/operators */
    List       *hj_OuterHashKeys;       /* list of ExprState nodes */
    List       *hj_InnerHashKeys;       /* list of ExprState nodes */
    List       *hj_HashOperators;       /* list of operator OIDs */

	  /* CSI3130: tuple slots used by the join */
    TupleTableSlot *hj_OuterTupleSlot;
    TupleTableSlot *hj_InnerTupleSlot;
    TupleTableSlot *inner_hj_HashTupleSlot;   /* tuple from inner hash table */
    TupleTableSlot *outer_hj_HashTupleSlot;   /* tuple from outer hash table */
    TupleTableSlot *hj_NullInnerTupleSlot;
    TupleTableSlot *hj_FirstOuterTupleSlot;
    TupleTableSlot *hj_FirstInnerTupleSlot;

    /* CSI3130: flags to track exhaustion and need for new tuples */
    ...
    bool        hj_InnerNotEmpty;       /* CSI3130: track non-empty inner relation */

    /* CSI3130: stats / counters for symmetric probing */
    int         matches_by_probing_inner;
    int         matches_by_probing_outer;

    /* CSI3130: which side to probe next: false = outer, true = inner */
