				...
				)
{
	...
	HashJoin   *join_plan;
	Hash	   *hash_plan;
	  /* CSI3130 - added outer hash node for symmetric hash join */
	 ...
	 */
    /*
     * CSI3130 - build hash nodes for both inner and outer inputs
     * to support symmetric hash join (two hash tables).
     */
    hash_plan = make_hash(inner_plan);

    /* CSI3130 - also hash the outer relation */
    ...
    join_plan = make_hashjoin(tlist,
                              ...
                              otherclauses,
                              hashclauses,
                              /* CSI3130 - outer hash becomes left child */
                              (Plan *) outer_hash_plan,
                              /* inner hash becomes right child */
                              (Plan *) hash_plan,
                              best_path->jpath.jointype);
